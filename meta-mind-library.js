    ...
    defaults: [
        {
            ...
            nodes: [
                ...
                { id: "t_wf", type: "web-footer", title: "Site Footer", content: '{"text":"© 2026 Meta-Mind Platform. All rights reserved."}', data: { x: 0, y: 350, isCore: false, collapsed: false }, submaps: [] }
            ],
            connections: [
